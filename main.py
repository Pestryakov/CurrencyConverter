...
def exchange():
    ...
    try:
        ...
        messagebox.showwarning('Check the amount you entered')
        root.destroy()
try:
    ...
    messagebox.showerror('Error', 'Error getting currency exchange rates')
...
# Header
h_currency = Label(header_frame, text='Сurrency', bg='#ccc', font='Arial 12 bold')
...
#UAH
l_uah = Label(calc_frame, text='UAH', bg='#fff', font='Arial 10 bold')
